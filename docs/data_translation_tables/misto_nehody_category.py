misto_nehody_category = {
    ...
    'zastávka tramvaje, autobusu, trolejbusu bez nástup. ostrůvku': 'tram, bus, trolleybus stop without a boarding island',
    'čerpadlo pohonných hmot': 'fuel pump',
    'železniční přejezd nezabezpečený závorami ani světelným výstražným zařízením': 'railway crossing not secured by barriers or light warning devices',
    'železniční přejezd zabezpečený': 'railway crossing secured',
    'žádné nebo žádné z uvedených': 'none of the above',
}
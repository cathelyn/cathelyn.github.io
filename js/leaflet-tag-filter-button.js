(function() {
    ...
    L.Control.TagFilterButton = L.Control.extend({
        ...
        addTo: function(map) {
            ...
            this._nameEl = L.DomUtil.create('ul', 'name', this._container);
            this._nameEl.innerHTML = "<li>" + this.options.name + "<button id='filter_close_button'><i class='fa-regular fa-circle-xmark'></i></button></li>";

            this._clearEl = L.DomUtil.create('ul', 'header', this._container);
            this._clearEl.innerHTML = "<li><a>" + this.options.clearText + "</a></li>";
